!function(e, t) {
    ...
    a.prototype = {
        ...
        access: function(e, t, n) {
            var r;
            return void 0 === t || t && "string" == typeof t && void 0 === n ? void 0 !== (r = this.get(e, t)) ? r : this.get(e, ie.camelCase(t)) : (this.set(e, t, n),
            void 0 !== n ? n : t)
        },
        remove: function(e, t) {
    ...
    ie.Animation = ie.extend(M, {
        ...
        prefilters: [function(e, t, n) {
            ...
            "inline" === ("none" === (l = ie.css(e, "display")) ? Ce.get(e, "olddisplay") || E(e.nodeName) : l) && "none" === ie.css(e, "float") && (p.display = "inline-block")),
...
!function(e) {
    ...
    e.fn.scrollTo = function(r, i, s) {
        ...
        this.each(function() {
            ...
            if (null !== r) {
                var f, c = t(this), l = c ? this.contentWindow || window : this, d = e(l), m = r, p = {};
                switch (typeof m) {
                case "number":
                case "string":
                    if (/^([+-]=?)?\d+(\.\d+)?(px|%)?$/.test(m)) {
                ...
                e.each(s.axis.split(""), function(e, t) {
                    var o = "x" === t ? "Left" : "Top"
                      ...
                      , x = d[i]()
                      , v = n.max(l, t);
                    f ? (p[i] = f[r] + (c ? 0 : x - d.offset()[r]),
                    s.margin && (p[i] -= parseInt(m.css("margin" + o), 10) || 0,
                    p[i] -= parseInt(m.css("border" + o + "Width"), 10) || 0),
                    p[i] += h[r] || 0,
                    s.over[r] && (p[i] += m["x" === t ? "width" : "height"]() * s.over[r])) : (o = m[r],
                    p[i] = o.slice && "%" === o.slice(-1) ? parseFloat(o) / 100 * v : o),
                    s.limit && /^\d+$/.test(p[i]) && (p[i] = 0 >= p[i] ? 0 : Math.min(p[i], v)),
                    !e && 1 < s.axis.length && (x === p[i] ? p = {} : a && (u(s.onAfterFirst),
                    p = {}))
                }),
                u(s.onAfter)
            }
...
!function(t, e, i, s) {
    ...
    n.prototype.pointer = function(t) {
        ...
        (t = t.touches && t.touches.length ? t.touches[0] : t.changedTouches && t.changedTouches.length ? t.changedTouches[0] : t).pageX ? (i.x = t.pageX,
    ...
    e.widget.bridge = function(t, i) {
        ...
        e.fn[t] = function(a) {
            ...
            o ? this.each(function() {
                ...
                !1) : n ? e.isFunction(n[a]) && "_" !== a.charAt(0) ? (i = n[a].apply(n, u)) !== n && void 0 !== i ? (r = i && i.jquery ? r.pushStack(i.get()) : i,
